...
export default function Carousel<T>({
  ...
  return (
    <div className="w-[90%] h-full mx-auto px-4">
      ...
      <div className="relative">
        ...
        <div className="h-full overflow-hidden mx-12 ">
          <motion.div
            className="h-full flex  transition-transform duration-500 ease-out items-stretch"
            animate={{
          ...
          >
            {items.map((item, index) =>
              item ? (
                <motion.div
                  key={index}
                  className="shrink-0 px-4 mx-auto flex justify-center h-full items-stretch"
