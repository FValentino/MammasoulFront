...
export default function ProductsDetail({index, product}: ProductsDetailProps) {
  ...
  return (
    ...
    <motion.div className="w-full flex justify-between items-center my-2 mx-auto border-b pb-1"
      key={product.id}
    ...
    >
      <div className="w-1/2 flex justify-around items-center ">
        <img
          src={product.product_images?.[0]?.url ?? "https://es.vecteezy.com/arte-vectorial/22059000-no-imagen-disponible-icono"}
          alt="Product"
